...
{
    public readonly List<Tuple<double, KategoriPengeluaran>> _table;
...
{
    public KategoriPengeluaranTable _kategoriPengeluaranTable;
    ...
    public object GetKategoriPengeluaran(Pengeluaran pengeluaran)
    {
